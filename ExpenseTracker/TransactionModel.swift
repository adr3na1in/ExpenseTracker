...
extension Category {
    ...
    static let publicTransporation = Category(id: 101, name: "Public Transporation", icon: .bus, mainCategoryId: 1)
    ...
    static let financeCharge = Category(id: 402, name: "Finance Charge", icon: .shopping_basket, mainCategoryId: 4)
...
extension Category {
    ...
    static let subCategiries: [Category] = [
        .publicTransporation,
        .taxi,
        .mobilePhone,
        .moviesAndDVDs,
    ...
    static let all: [Category] = categories + subCategiries
}
